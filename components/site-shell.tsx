    ...
    return (
        <div className="w-full p-6 text-sm leading-6 text-rurikon-500 antialiased sm:p-10 sm:text-[15px] sm:leading-7 md:p-14 md:text-base md:leading-7">
            ...
            <div className="flex flex-col mobile:flex-row">
                <nav className="w-full mobile:mr-6 mobile:w-16 sm:mr-10 md:mr-14">
                    <ul className="mb-6 flex justify-end gap-2 text-right lowercase mobile:sticky mobile:top-6 mobile:mb-0 mobile:block sm:top-10 md:top-14">
