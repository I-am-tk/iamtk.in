...
summary: "“The reality we can put into words is never reality itself.”"
---
# Enlightment II
...
Mathematically, it is expressed as $\Delta x \cdot \Delta p \geq \hbar/2$ where $\Delta x$ is the uncertainty in position, $\Delta p$ is the uncertainty in momentum, and $\hbar$ is just a relatively small constant (the reduced Planck constant).
